...
// native callback -- see use in example 6 
...
int main()
{
	...
	options[0].optionString = "-Djava.class.path=.:/home/yuanwenxing/eclipse-workspace/JavaExample6/bin/";   // where to find java .class
	...
	if(cls2 == nullptr) {
		...
		//========== Example 5 revised for 6 ======== create object and call method =================
