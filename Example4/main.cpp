...
int main()
{
	...
	options[0].optionString = "-Djava.class.path=.:/home/yuanwenxing/eclipse-workspace/JavaExample4/bin/";   // where to find java .class
	...
	if(cls2 == nullptr) {
		...
		//========== Example 4 added: static function with string array==================
